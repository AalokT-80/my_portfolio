...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'tiwariaalok.2004@gmail.com'         # Replace with your email
EMAIL_HOST_PASSWORD = 'qvpm ifyz cdib rfwl'        # Replace with App Password (NOT your email password)
